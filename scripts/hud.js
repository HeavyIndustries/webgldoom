...
he3d.game.fpweap.draw = function() {
	...
	for (var fpwi = 0;fpwi<he3d.game.fpweap.drawlist.length;fpwi++) {
		...
		he3d.gl.bindTexture(he3d.gl.TEXTURE_2D, 
			he3d.t.textures[he3d.game.fpweap.vbo.texture].texture);
...
he3d.game.fpweap.update = function() {
	...
	this.bobdelta[0] += this.bobdelta[0] *
		he3d.m.dirtycos(he3d.m.degtorad(he3d.game.player.angle[1]));
	this.bobdelta[1] += this.bobdelta[1] *
		he3d.m.dirtysin(he3d.m.degtorad(he3d.game.player.angle[1]));
		
	this.bob = (this.bobdelta[0] + this.bobdelta[1]) +
		he3d.m.dirtysin(he3d.m.degtorad(this.bobangle));
	...
	this.drawlist.push({
		...
		offset:	[0 - (this.items[weap].width / 2) + this.bob,
			(-120 + this.items[weap].height / 2) + -this.bob]
	});
};
...
he3d.game.statusbar.draw = function() {
	...
	for (var hi = 0;hi<he3d.game.statusbar.drawlist.length;hi++) {
		...
		he3d.gl.activeTexture(he3d.gl.TEXTURE0);
		he3d.gl.bindTexture(he3d.gl.TEXTURE_2D, 
			he3d.t.textures[he3d.game.statusbar.vbo.texture].texture);
		he3d.gl.uniform1i(he3d.r.curProgram.uniforms.texture,  0);
...
he3d.game.hud = function() {
	...
	this.ctx.fillText("Toggle Walls - Z / Flats - X / Sky - C " +
		"/ Lines - V / Things - B / Coltest - N / Status Bar - m", 0, 0);
	this.ctx.translate(0, 12);
	this.ctx.fillText("Trace BSP - ,  / Toggle SSAO - . " +
		"/ View Normals - K / Toggle Dynamic Lights - L", 0, 0);
	this.ctx.translate(0, 12);
	...
	if (he3d.game.player.sector>0)
		this.ctx.fillText("Floor material: " +
			he3d.game.map.sectors[he3d.game.player.sector].tex_f, 0, 0);
