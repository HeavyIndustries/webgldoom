...
he3d.game.player.init = function() {
	...
	// Set Camera pos
	this.pos.set([
		he3d.game.map.spawnPos[0],
		he3d.game.map.spawnPos[1],
		he3d.game.map.spawnPos[2]]);
...
he3d.game.player.update = function() {
	...
	if (he3d.i.keys[he3d.e.keys.LEFT_ARROW])
		this.angle[1] += this.k_turnspeed * he3d.timer.delta;
	if (he3d.i.keys[he3d.e.keys.RIGHT_ARROW])
		this.angle[1] -= this.k_turnspeed * he3d.timer.delta;
...
//			this.delta[2] -= (he3d.i.mouse.delta[1] * (this.accel / this.speed)) * he3d.timer.delta;
	...
	if (this.freecam) {
		...
		if (he3d.i.keys[he3d.e.keys.E])
			this.delta[1] +=  this.speed.walk;
		if (he3d.i.keys[he3d.e.keys.Q])
			this.delta[1] += -this.speed.walk;
		if (he3d.i.keys[he3d.e.keys.DOWN_ARROW])
			this.angle[0] += (this.k_turnspeed) * he3d.timer.delta;
		if (he3d.i.keys[he3d.e.keys.UP_ARROW])
			this.angle[0] -= (this.k_turnspeed) * he3d.timer.delta;
	...
	if (!this.freecam && (this.delta[0] || this.delta[2] || this.delta[3])) {
		...
		var sector = he3d.game.map.findSector([
			-(this.pos[0] + this.delta[0]),
	...
	this.thing.pos[0] =	-Math.round(this.pos[0] + this.delta[0]);
	this.thing.pos[1] =	-Math.round(this.pos[1] + this.delta[1]);
	this.thing.pos[2] =	-Math.round(this.pos[2] + this.delta[2]);
