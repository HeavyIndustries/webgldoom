...
/*
	...
	Sooooooooooooo for choosing the right THING sprite -

	for TROOA2A8 sprite
	 
	imagename = spritenames[spritenum_t[states_t[thing.<whateverstate>].sprite]]+ // TROO
		number to letter (states_t[thing.<whateverstate>].frame)+	// A
		thing[t].angle	// 2
		
	if there is another frame on the end (A8) its used as a mirror version
